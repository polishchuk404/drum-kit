  window.addEventListener('keydown', (e) => {
    document.querySelector(`div[data-key="${event.code}"]`).classList.toggle('playing');
    document.querySelector(`audio[data-key="${event.code}"]`).play();
  });

  window.addEventListener('keyup', (e) => document.querySelector(`div[data-key="${event.code}"]`).classList.toggle('playing')); 

  window.addEventListener('mouseup', (e) => {
    document.querySelector('div').click(`"${document.querySelector(`div[data-key="${event.code}"]`).classList.toggle('playing')}"`);
    document.querySelector(`audio[data-key="${event.code}"]`).play();
	});
//   $(".key").click(function() {
