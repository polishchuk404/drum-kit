  window.addEventListener('keyup', (e) => {
    document.querySelector(`div[data-key="${event.keyCode}"]`).classList.toggle('playing');
    document.querySelector(`audio[data-key="${event.keyCode}"]`).play();
  });

  window.addEventListener('keydown', (e) => document.querySelector(`div[data-key="${event.keyCode}"]`).classList.toggle('playing')); 

  // window.addEventListener('mouseup', (e) => {
  //   document.querySelector('div').click(`"${document.querySelector(`div[data-key="${e.keyCode}"]`).classList.toggle('playing')}"`);
